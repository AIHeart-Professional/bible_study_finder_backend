...
class GroupsService:
    ...
    async def get_group_users(self, groupId: str) -> tuple[bool, str, List[GroupMember]]:
        ...
        try:
            ...
            return True, "Users retrieved successfully", members
            
        except Exception as e:
            self.logger.error(f"Error getting group users: {e}")
            return False, f"Error getting group users: {str(e)}", []
